...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-primary-600 via-primary-700 to-purple-700 items-center justify-center p-12">
        {/* Decorative circles */}
        ...
        <div className="relative text-center">
          ...
          <p className="text-lg text-white/70 max-w-sm">
            Sign in to access your dashboard, manage your projects, and track your progress.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white dark:bg-surface-950">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border-2 border-surface-200 dark:border-surface-700 text-sm font-medium text-surface-700 dark:text-surface-300 hover:bg-surface-50 dark:hover:bg-surface-800 transition-colors">
          ...
          <div className="mt-8 p-4 rounded-xl bg-primary-50 dark:bg-primary-500/10 border border-primary-200 dark:border-primary-500/20">
            <p className="text-xs text-primary-700 dark:text-primary-400">
              <span className="font-semibold">Demo:</span> Register a new account to try the dashboard, or use any email/password combination.
            </p>
          </div>
        </div>
      </div>
